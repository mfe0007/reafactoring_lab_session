...
<p><strong>Precondition:</strong> (type >= NODE) & (type <= PRINTER);</p>
	...
	public void switchPrintHTMLOn(Network network, StringBuffer buf, Node currentNode) {
		do {
			buf.append("\n\t<LI> ");
	...
	public void switchPrintXMLOn(Network network, StringBuffer buf, Node currentNode) {
		do {
			buf.append("\n\t");
			switch (currentNode.type_) {
			case Node.NODE:
	...
	public void switchNode(Network network, StringBuffer buf, Node currentNode, String v1, String v2) {
		do {
			switch (currentNode.type_) {
			case Node.NODE:
				buf.append("Node ");
